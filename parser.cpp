...
{
       0,    46,    46,    51,    45,    59,    60,    64,    69,    77,
     102,   106,   107,   120,   121,   125,   126,   130,   145,   154,
     159,   144,   168,   177,   167,   185,   195,   199,   218,   241,
     245,   246,   250,   251,   255,   259,   260,   262,   269,   261,
     280,   288,   279,   299,   304,   338,   359,   454,   458,   465,
     469,   487,   488,   501,   506,   514,   515,   523,   545,   623,
     624,   628,   649
};
#endif
...
#line 145 "parser.y" /* yacc.c:1646  */
    {	
				...
				myGenCode(FUN, (yyvsp[0]) ,true ,-1 ,true ,-1 ,true);
			}
...
#line 168 "parser.y" /* yacc.c:1646  */
    { 	
				...
				myGenCode(PROC ,(yyvsp[0]) ,true ,-1 ,true ,-1 ,true);
			}
...
#line 200 "parser.y" /* yacc.c:1646  */
    {	
				for(auto &index : argParamVectorHelper){
					...
					{
						SymbolTable[index].type = (yyvsp[0]);
					}
					paramHelper.push_back(make_pair((yyvsp[0]), arrayInfoHelper));
...
#line 256 "parser.y" /* yacc.c:1646  */
    {
				myGenCode(ASSIGN,(yyvsp[-2]),true,-1, true,(yyvsp[0]),true);
			}
...
#line 262 "parser.y" /* yacc.c:1646  */
    {	
				...
				myGenCode(EQ, label1, true, (yyvsp[0]), true, num, true);
				(yyvsp[0]) = label1;
			}
...
#line 269 "parser.y" /* yacc.c:1646  */
    {	
				...
				myGenCode(LABEL, (yyvsp[-3]), true, -1, true, -1, true);
				(yyvsp[0]) = label2;
			}
...
#line 288 "parser.y" /* yacc.c:1646  */
    {	int id = insertNum("0",INTEGER);
				myGenCode(EQ, (yyvsp[-2]), true, (yyvsp[-1]), true, id, true);
			}
...
#line 292 "parser.y" /* yacc.c:1646  */
    {	
				myGenCode(JUMP, (yyvsp[-5]), true, -1, true, -1, true);
				myGenCode(LABEL, (yyvsp[-4]), true, -1, true, -1, true);
			}
...
#line 305 "parser.y" /* yacc.c:1646  */
    {	
				if(SymbolTable[(yyvsp[-1])].type == REAL)
				{
					...
					myGenCode(REALTOINT, t, true, (yyvsp[-1]), true, -1, true);
					(yyvsp[-1]) = t;
				}
				
				int startId = SymbolTable[(yyvsp[-3])].arrayInfo.startId;
				int t1 = insertTempSymbol(INTEGER);
				myGenCode(MINUS, t1, true, (yyvsp[-1]), true, startId, true);
				...
				else if(SymbolTable[(yyvsp[-3])].type == REAL)
				{
				...
				myGenCode(PLUS, addressArray, true, (yyvsp[-3]), false, t1, true);

				SymbolTable[addressArray].isReference = true;
				SymbolTable[addressArray].type = SymbolTable[(yyvsp[-3])].type;
				(yyval) = addressArray;
			}
...
#line 339 "parser.y" /* yacc.c:1646  */
    {	
				checkSymbolExist((yyvsp[0]));
				if(SymbolTable[(yyvsp[0])].token == FUN || SymbolTable[(yyvsp[0])].token == PROC)
				{
					if(SymbolTable[(yyvsp[0])].parameters.size() > 0)
					{
...
#line 360 "parser.y" /* yacc.c:1646  */
    {	
				...
				{
					string funName = SymbolTable[(yyvsp[-3])].name;
					...
					if(SymbolTable[finId].token == FUN || SymbolTable[finId].token == PROC)
					{
						...
						if(SymbolTable[(yyvsp[-3])].token == FUN)
						{
							int id = insertTempSymbol(SymbolTable[(yyvsp[-3])].type);
							myGenCode(PUSH,id,false,-1, true, -1, true);
							incspCount += 4;
							(yyval) = id;
						}
						myGenCode(CALL, (yyvsp[-3]),true,-1,true,-1,true);
						stringstream helper;
						helper << incspCount;
...
#line 470 "parser.y" /* yacc.c:1646  */
    {
			...
			myGenCode((yyvsp[-1]), newLabelPass, true, (yyvsp[-2]), true, (yyvsp[0]), true);
...
#line 489 "parser.y" /* yacc.c:1646  */
    {
				...
				else if((yyvsp[-1]) == MINUS)
				{
					...
					int t0 = insertNum("0",SymbolTable[(yyvsp[0])].type);
					myGenCode((yyvsp[-1]), (yyval), true, t0, true, (yyvsp[0]), true);
				}
			}
...
#line 502 "parser.y" /* yacc.c:1646  */
    {
				(yyval) = insertTempSymbol(getResultType((yyvsp[-2]), (yyvsp[0])));
				myGenCode((yyvsp[-1]), (yyval), true, (yyvsp[-2]), true, (yyvsp[0]), true);
			}
...
#line 507 "parser.y" /* yacc.c:1646  */
    {
				(yyval) = insertTempSymbol(INTEGER);
				myGenCode(OR, (yyval), true, (yyvsp[-2]), true, (yyvsp[0]), true);
			}
...
#line 629 "parser.y" /* yacc.c:1646  */
    {	
				...
				myGenCode(EQ,labelFactorEqualZero, true, (yyvsp[0]), true,  zeroId, true);
