...
#line 262 "parser.y" /* yacc.c:1646  */
    {	
				...
				writeToOutputByToken(EQ, label1, true, (yyvsp[0]), true, num, true);
				(yyvsp[0]) = label1;
			}
...
#line 288 "parser.y" /* yacc.c:1646  */
    {	int id = insertNum("0",INTEGER);
				writeToOutputByToken(EQ, (yyvsp[-2]), true, (yyvsp[-1]), true, id, true);
			}
...
#line 305 "parser.y" /* yacc.c:1646  */
    {	
				if(SymbolTable[(yyvsp[-1])].type == REAL)
				{
					...
					writeToOutputByToken(REALTOINT, t, true, (yyvsp[-1]), true, -1, true);
					(yyvsp[-1]) = t;
				}
				
				int startId = SymbolTable[(yyvsp[-3])].arrayInfo.startId;
				int t1 = insertTempSymbol(INTEGER);
				writeToOutputByToken(MINUS, t1, true, (yyvsp[-1]), true, startId, true);
				...
				writeToOutputByToken(PLUS, addressArray, true, (yyvsp[-3]), false, t1, true);
    ...
    {	
				...
				else
				{
					...
					if(SymbolTable[finId].token == FUN || SymbolTable[finId].token == PROC)
					{
						...
						writeToOutputByToken(CALL, (yyvsp[-3]),true,-1,true,-1,true);
						stringstream helper;
						helper << incspCount;
...
#line 470 "parser.y" /* yacc.c:1646  */
    {
			...
			writeToOutputByToken((yyvsp[-1]), newLabelPass, true, (yyvsp[-2]), true, (yyvsp[0]), true);
...
#line 489 "parser.y" /* yacc.c:1646  */
    {
				...
				else if((yyvsp[-1]) == MINUS)
				{
					...
					writeToOutputByToken((yyvsp[-1]), (yyval), true, t0, true, (yyvsp[0]), true);
				}
			}
...
#line 507 "parser.y" /* yacc.c:1646  */
    {
				...
				writeToOutputByToken(OR, (yyval), true, (yyvsp[-2]), true, (yyvsp[0]), true);
			}
